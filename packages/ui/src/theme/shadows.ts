...
//
import {Palette as palette} from './GlobalToken/Palette';
...
const LIGHT_MODE = palette.gray[5];
...
const createCustomShadow = (color: string) => {
  ...
  return {
    ...
    //
    primary: `0 8px 16px 0 ${alpha(palette.red[5], 0.24)}`,
    info: `0 8px 16px 0 ${alpha(palette.blue[4], 0.24)}`,
    secondary: `0 8px 16px 0 ${alpha(palette.blue[4], 0.24)}`,
    success: `0 8px 16px 0 ${alpha(palette.blue[4], 0.24)}`,
    warning: `0 8px 16px 0 ${alpha(palette.blue[4], 0.24)}`,
    error: `0 8px 16px 0 ${alpha(palette.blue[4], 0.24)}`,
    //
